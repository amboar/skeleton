...
LDLIBS=$(shell pkg-config --libs gio-unix-2.0 glib-2.0) -Llib -lopenbmc_intf
...
power_control: power_control_obj.o gpio.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/gpio.o obj/power_control_obj.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)

led_controller: led_controller_obj.o gpio.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/gpio.o obj/led_controller_obj.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)

led_controller_new: led_controller_new.o
	$(CC) -o bin/$@.exe obj/led_controller_new.o $(LDFLAGS) $(LDLIBS) -lsystemd

button_power: button_power_obj.o gpio.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/button_power_obj.o obj/gpio.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)

button_reset: button_reset_obj.o gpio.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/button_reset_obj.o obj/gpio.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)


control_host: control_host_obj.o gpio.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/gpio.o obj/control_host_obj.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)

flash_bios:  flash_bios_obj.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/flash_bios_obj.o obj/object_mapper.o $(LDFLAGS) $(LDLIBS)

host_watchdog: host_watchdog_obj.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/host_watchdog_obj.o obj/object_mapper.o  $(LDFLAGS) $(LDLIBS)

board_vpd: board_vpd_obj.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/board_vpd_obj.o $(LDFLAGS) $(LDLIBS)

pcie_slot_present: pcie_slot_present_obj.o gpio.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/pcie_slot_present_obj.o obj/gpio.o $(LDFLAGS) $(LDLIBS)

flasher:  $(OBJS2) flasher_obj.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/flasher_obj.o $(OBJS3) $(LDFLAGS) $(LDLIBS)
...
hwmons_barreleye: hwmons_barreleye_obj.o object_mapper.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/hwmons_barreleye_obj.o obj/object_mapper.o  $(LDFLAGS) $(LDLIBS)

control_bmc: control_bmc_obj.o libopenbmc_intf
	$(CC) -o bin/$@.exe obj/control_bmc_obj.o $(LDFLAGS) $(LDLIBS)
